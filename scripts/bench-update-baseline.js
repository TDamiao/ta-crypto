...
record("sma(20)", "batch.sma20.100k", () => sma(data100k.close, 20), 100000, 2);
record("ema(20)", "batch.ema20.100k", () => ema(data100k.close, 20), 100000, 2);
record("rsi(14)", "batch.rsi14.100k", () => rsi(data100k.close, 14), 100000, 2);
record("macd(12,26,9)", "batch.macd.100k", () => macd(data100k.close, 12, 26, 9), 100000, 2);
record("bbands(20,2)", "batch.bbands20.100k", () => bbands(data100k.close, 20, 2), 100000, 2);
record("atr(14)", "batch.atr14.100k", () => atr(data100k.high, data100k.low, data100k.close, 14), 100000, 2);
record("adx(14)", "batch.adx14.100k", () => adx(data100k.high, data100k.low, data100k.close, 14), 100000, 1);
record("mfi(14)", "batch.mfi14.100k", () => mfi(data100k.high, data100k.low, data100k.close, data100k.volume, 14), 100000, 2);
record("vwap(20)", "batch.vwap20.100k", () => vwap(data100k.high, data100k.low, data100k.close, data100k.volume, 20), 100000, 2);
record("volumeDelta(14)", "batch.volumeDelta14.100k", () => volumeDelta(data100k.open, data100k.close, data100k.volume, 14), 100000, 2);
record("orderflowImbalance(14)", "batch.orderflowImbal14.100k", () => orderflowImbalance(data100k.open, data100k.close, data100k.volume, 14), 100000, 2);
record("realizedVolatility(30)", "batch.realizedVol30.100k", () => realizedVolatility(data100k.close, 30, 365), 100000, 2);
record("volatilityRegime(30)", "batch.volatilityRegime30.100k", () => volatilityRegime(data100k.close, 30, 365, -0.5, 0.5), 100000, 2);

// 3. Stateful Streaming (100k items)

...
4. **npm Trusted Publishing & OIDC**: Releases use OpenID Connect (OIDC) identity federation between GitHub Actions and npm within the protected GitHub Environment `npm-publish`, eliminating long-lived npm tokens.
